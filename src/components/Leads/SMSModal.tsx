      ...
      <div className="bg-white rounded-lg max-w-md w-full">
        ...
        <div className="p-6">
          ...
          <div className="mb-6 p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">{lead.phone || 'No phone number'}</div>
                {lead.company && (
          ...
          {!lead.phone && (
            <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg">
              <p className="text-red-800 text-sm">
                <strong>Warning:</strong> This lead doesn't have a phone number. Please add one before sending SMS.
              </p>
            </div>
          )}
          ...
          <div className="flex items-center justify-end space-x-3">
            ...
            <button
              onClick={handleSend}
              disabled={!message.trim() || !lead.phone || remainingChars < 0 || isSending}
